                    ...
                    <div className="container-fluid">
                                    ...
                                    <div className="card-body ">
                                        <div className="row">
                                            ...
                                            <div className="col-md-6 ml-auto mr-auto">
                                                <div id="worldMap" style={styles.worldMap}></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="row">
                            <div className="col-md-4">
                                <div className="card card-product">
                                    <div className="card-header card-header-image" data-header-animation="true">
                                        <a href="#pablo">
                                        <img className="img" src="./assets/img/card-2.jpg" alt=""/>
                                        </a>
                                    </div>
                                    <div className="card-body">
                            ...
                            <div className="col-md-4">
                                ...
                                <div className="card-header card-header-image" data-header-animation="true">
                                    <a href="#pablo">
                                    <img className="img" src="./assets/img/card-3.jpg" alt=""/>
                                    </a>
                                </div>
                                <div className="card-body">
                                    <div className="card-actions text-center">
                            ...
                            <div className="col-md-4">
                                <div className="card card-product">
                                    <div className="card-header card-header-image" data-header-animation="true">
                                        <a href="#pablo">
                                        <img className="img" src="./assets/img/card-1.jpg" alt=""/>
                                        </a>
                                    </div>
                                    <div className="card-body">
                                        <div className="card-actions text-center">
